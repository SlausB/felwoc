		...
		case Field::INHERITED:
			{
				...
				InheritedField* inheritedField = new InheritedField(parentField, root->table);
				...
				case TableParamsKeywords::PARENT:
					{
						...
						if(worksheets[worksheetIndex].parentName.compare(table->name) == 0)
						{
